...
from .views import DeviceListView, DeviceDetailView, ControllerListView, ControllerDetailView, RoomListView, RoomDetailView, LocationListView, LocationDetailView
